---
title: Multimodal Perception & Scene Intelligence
...
- Robust visual and multimodal scene understanding
- Camera–LiDAR perception and sensor fusion
- 2D and 3D environment representation
- Object detection, segmentation and tracking
- Perception under adverse weather and illumination
- Learning with limited or reduced supervision
- Physics-informed and model-based perception

## Emerging directions

- Multimodal foundation models
- Open-world and open-vocabulary perception
- Uncertainty-aware scene interpretation
- Generative approaches for perception and representation learning
