...
class ValidationTest < Minitest::Test
  ...
  def test_forbidden_files
    %w[scripts/tool.py Dockerfile deploy.sh Gemfile.lock .env .env.example _.htpasswd assets/jsconfig.json auth-broker/README.md auth-broker/src/index.ts auth-broker/wrangler.toml].each do |path|
